package com.acme.backendfreshsense.alerts.application.service;
...
public class AlertService {
    ...
    public AlertResponse create(AlertRequest request, Long userId) {
    ...
    private AlertResponse toResponse(Alert a) {
        return new AlertResponse(a.getId(), a.getTitle(), a.getMessage(),
                a.getSeverity(), a.getSource(), a.getState(), a.getTimeAgo());
    }
}
